...
await message.client.sendMessage(message.jid, fs.readFileSync('./gif/mention.mp4'), MessageType.video, { mimetype: Mimetype.mp4, quoted : message.data, ptt: false})
...
if(pattern.test(message.message)){
   ...
   await message.client.sendMessage(message.jid, fs.readFileSync('./gif/' + a + '.mp4'), MessageType.video, { mimetype: Mimetype.mp4, quoted: message.data, ptt: false})
